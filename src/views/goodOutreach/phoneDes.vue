  ...
  <div class="shot-content" :class="{ 'seenCls': !seen }">
    ...
    <div class="tab_content">
      <el-radio-group v-model="tabRadio">
        ...
        <el-button type="primary" class="tab_btn_t">评论数<i class="el-icon-sort el-icon--right" /></el-button>
        <el-button type="primary" class="tab_btn_t">价格<i class="el-icon-sort el-icon--right" /></el-button>
        <!-- <el-radio label="价格" border /> -->
      </el-radio-group>
      <el-divider />
    </div>
    <div class="img__content mt0">
      <child :seen="seen" />
    </div>
  </div>
</template>
