<template>
  <div class="tab_content">
    <el-row class="mb0">
      <el-button
        type="text"
        class="ml122 my_btn ty2"
        icon="el-icon-postcard btn_i"
        :class="{ 'g-color': !ruzhu }"
        size="mini"
        @click="jumpAttestation"
        >实名认证</el-button
      >
      <el-col :span="6">
        <el-avatar
          :size="150"
          :src="(userinfo && userinfo.avatar) || defaultNick"
          class="tx_cls"
          fit="fill "
        />
      </el-col>
      <el-col :span="18">
        <el-descriptions :column="1" class="mt72 des_my">
          ...
          <el-descriptions-item label="手机 " label-class-name="lh30"
            ...
            <el-button
              type="warning"
              class="ml204 ty2 priIn2"
              size="mini"
              @click="handleClickTiXian"
              >申请提现</el-button
            >
          </el-descriptions-item>
          <el-descriptions-item label="余额" label-class-name="lh30"
            >{{ userinfo && userinfo.money }}

            <el-button
              type="warning"
              class="ml2042 ty2 priIn"
              size="mini"
    ...
    <el-dialog
      title="修改资料"
      :visible.sync="dialogFormVisibleData"
      width="30%"
    >
    ...
    >
      ...
      <div class="mlf20" />
      <div slot="footer" class="dialog-footer tc">
        <el-button type="warning" @click="dialogFormVisiblePassWord = false"
          >提 交</el-button
        >
      </div>
    </el-dialog>
...
export default {
  data() {
    ...
    return {
      ...
      formData: {
        avatar: require("@/assets/img/spzy/defaultImg.png"),
        nick: "默认用户",
        mobile: "",
        Code: "",
      },
  ...
  methods: {
    userInfoEcho() {
      ...
      this.formData = {
        avatar: userInfo.avatar || this.defaultNick,
        nick: userInfo.nick || this.defaultName + userInfo.id,
