      ...
      <ul class="note-list" infinite-scroll-url="/">
        <li v-for="(item, index) in imgsArr" :key="index" class="have-img">
          <!-- <a class="wrap-img" href="#" target="_blank">
            <img class="img-blur-done" :src="item.src" :alt="item.info">
          </a> -->
          <div class="content">
            ...
            <div class="meta">
              ...
              <a target="_blank" href="#">
                浏览量
                <i class=" el-icon-view" /> {{ item.num }}
              </a>

              <a target="_blank" href="#">
                投标量
                <i class="el-icon-s-check" /> 8 人
              </a>
              <a target="_blank" href="#">
      ...
      imgsArr: [
        {
          ...
          statuss: true,
          num: '115',
          title: '需求记录| 需求记录|需求记录|需求记录|需求记录|需求记录|需求记录|需求记录|需求记录|需求记录|需求记录|需求记录|需求记录|需求记录|需求记录|需求记录|需求记录|需求记录|需求记录|需求记录|需求记录|',
