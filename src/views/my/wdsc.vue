<template>
  <div class="tab_content">
    <div class="list-container">
        ...
        <li v-for="(item, index) in shoucang" :key="index" class="have-img">
          ...
          <div class="content">
            ...
            <div class="meta">
              ...
              <a target="_blank" href="#">
                投标量
                <i class="el-icon-s-check" /> {{ item.toubiao }}
              </a>
            </div>
          </div>
          <div class="wrap-btn">
      ...
      <div v-else>
        <el-empty description="暂时未发现你的收藏"></el-empty>
      </div>
      <!-- 文章列表模块 -->
      <el-row class="m50">
        <el-col :span="24">
...
export default {
  ...
  data() {
    return {
      ...
      //     statuss: false,
      //     num: '115', sc: true,
      //     title: '我的收藏23| 我的收藏|我的收藏|我的收藏|我的收藏|我的收藏|我的收藏|我的收藏|我的收藏|我的收藏|我的收藏|我的收藏|我的收藏|我的收藏|我的收藏|我的收藏|我的收藏|我的收藏|我的收藏|我的收藏|我的收藏|',
