  ...
  <div class="loginBox">
          ...
          <div v-if="!weChat">
                ...
                <div class="tabcontent">
                  ...
                  <div class="phoneInputGroup">
                    <label for="" class="inputLabel phoneLabel">
                      <input id="phoneInput" type="text" v-model="phome" name="" class="inputStyle phoneInput"
                ...
                <div class="tabcontent">
                  <div class="flex_input">
                    <label for="" class="inputLabel">
                      <input id="msgInput" type="number" value="" name="" class="inputStyle msgInput"
                        placeholder="输入 6 位短信验证码" autocomplete="off" v-model="CodeUser" />


                      <el-button style="height: 40px" :type="!canClick ? 'warning' : 'info'" class="Right_float"
                        @click="CodeFun" :disabled="canClick">
                        {{ btnText }}
                      </el-button>
                    </label>
            ...
            <div v-if="!active" class="tabcont tabContentAccount box_hover">
              <div class="tabcontent">
                <div class="phoneInputGroup">
                  <label for="" class="inputLabel phoneLabel">
                    <input id="accountUser" type="text" value="" name="" class="inputStyle accountUsername"
                      placeholder="手机号或邮箱" autocomplete="off" />
                  </label>
                </div>
              </div>
              <div class="tabcontent">
                <div class="phoneInputGroup">
                  <label for="" class="inputLabel phoneLabel">
                    <input id="accountpwd" type="password" value="" name="" class="inputStyle accountPwd" placeholder="密码"
                      autocomplete="off" />
                  </label>
                </div>
            ...
            <button v-if="active" class="button fromSubmit" data-type="smsSubmit" @click.prevent="UserLogin">
              注册/登录
            </button>
            <button v-if="!active" type="submit" class="button fromSubmit" data-type="smsSubmit">
              登录
            </button>
            <!-- tips -->
          ...
          <div v-if="weChat">
            <div class="ercodeBox">
              <div id="qrcode" class="Qrcode-img" title="">
                ...
                <canvas width="150" height="150" style="display: none" /><img alt="Scan me!"
            ...
            <svg width="52" height="52" xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor">
              ...
              <g fill="none" fill-rule="evenodd">
                ...
                <g mask="url(#id-14580708-b)">
                  ...
                  <path fill="#BE791A" d="M31 15.483v1.17l8 3.577 8-3.577v-1.17l-8 3.581z" fill-rule="nonzero" />
                </g>
              </g>
            </svg>
          </div>
    ...
    <div class="footSign signSocial">
      ...
      <span class="Login-socialButtonGroup">
        <button type="button" class="button Login-socialButton" @click="handleW">
      ...
      if (Cookies.get("code")) {
        if (this.CodeUser == this.userCode) {
          ...
          if (res.status == 200 && res.data.data) {
            ...
            this.$store.dispatch("user/getUserInfo", { id: String(res.data.data) })
